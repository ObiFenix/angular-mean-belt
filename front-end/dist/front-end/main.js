...
module.exports = ".btn {\n  font-size: 9px;\n  letter-spacing: .1rem;\n  width: 10rem !important;\n  margin-right: 1rem; }\n\n.flexed {\n  justify-content: flex-end; }\n\n.container {\n  width: 60% !important;\n  background-color: #29212a57;\n  color: #f5f5f5; }\n\n.btn {\n  margin: 3rem 15% 1rem !important; }\n\n.card-reveal img {\n  width: 100% 100px; }\n\n.margined {\n  margin: 0 0.5rem; }\n\ntr:hover {\n  background: #40332352;\n  border-radius: 10rem; }\n\nthead {\n  color: #ada8a8f2 !important;\n  background: #10151475 !important;\n  font-family: 'Days One', sans-serif; }\n\ntable {\n  border-spacing: 1px; }\n\ntrheader th:last-child {\n  padding-left: 6rem !important; }\n\n.scrolling-wrapper {\n  -webkit-overflow-scrolling: touch;\n  margin: 0rem auto !important;\n  max-height: 730px !important;\n  width: 60%;\n  overflow-y: scroll;\n  position: relative;\n  opacity: 0.8; }\n\n.scrolling-wrapper .img {\n    width: 100%;\n    max-height: 550px; }\n\n@media (max-width: 1600px) {\n    .scrolling-wrapper {\n      width: 70% !important; } }\n\n@media (max-width: 1400px) {\n    .scrolling-wrapper {\n      width: 80% !important; } }\n\n@media (max-width: 787px) {\n    .scrolling-wrapper {\n      width: 100% !important; } }\n\n::-webkit-scrollbar {\n  width: 12px; }\n\n::-webkit-scrollbar-track {\n  display: none; }\n\n.cuisine {\n  font-family: 'Indie Flower', cursive; }\n\n@media (max-width: 600px) {\n  .scrolling-wrapper[_ngcontent-c2] .img[_ngcontent-c2] {\n    width: 100%;\n    margin: 0 auto;\n    min-height: 292px;\n    /* max-height: 550px; */ }\n    .scrolling-wrapper[_ngcontent-c2] .img[_ngcontent-c2] img {\n      width: 100%;\n      min-height: 14rem; }\n  .scrolling-wrapper[_ngcontent-c2] {\n    -webkit-overflow-scrolling: touch;\n    margin: 0rem auto !important;\n    max-height: 443px !important;\n    width: 60%; }\n  .container-img .card-reveal img {\n    width: 100%;\n    max-height: 110px; }\n  .card-content {\n    padding: 1rem;\n    border-radius: 0 0 2px 2px; }\n    .card-content .links {\n      display: flex !important; }\n    .card-content .card .card-title {\n      font-size: 16px;\n      font-weight: 500; }\n    .card-content p {\n      margin: 0;\n      font-size: 12px; }\n      .card-content p span {\n        display: block; }\n      .card-content p a .material-icons {\n        font-family: 'Material Icons';\n        display: inline-block;\n        font-size: 20px; } }\n"
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.getRestaurants = function () {
        ...
        observable.subscribe(function (doc) {
            ...
            for (var index in _this.restaurants) {
                console.log(_this.restaurants[index].name);
                if (_this.restaurants[index].name === 'Spice Hut') {
                    _this.spicehut_id = _this.restaurants[index]._id;
                }
                if (_this.restaurants[index].name === 'Pappas Bros') {
                    _this.pappasbros_id = _this.restaurants[index]._id;
                }
                if (_this.restaurants[index].name === 'Dickey\'s Barbecue Pit') {
                    _this.dbpit_id = _this.restaurants[index]._id;
                }
                if (_this.restaurants[index].name === 'The Mansion Restaurant') {
                    _this.mansionR_id = _this.restaurants[index]._id;
                }
                if (_this.restaurants[index].name === 'El Mapache') {
                    _this.mapache_id = _this.restaurants[index]._id;
                }
            }
        });
    };
